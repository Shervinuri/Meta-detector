...
export const startLiveSession = (callbacks: {
    ...
    sessionPromise = ai.live.connect({
        ...
        config: {
            ...
            systemInstruction: "شما یک دستیار مفید با قابلیت بینایی هستید. شما یک جریان پیوسته از فریم‌های تصویر از دوربین کاربر، همراه با صدای گفتاری او دریافت خواهید کرد. نقش اصلی شما شناسایی و مکان‌یابی اشیاء در فید دوربین بر اساس درخواست‌های کاربر است. هنگامی که کاربر از شما می‌خواهد چیزی را پیدا کنید، از ابزار `displayDetectedObjects` برای نمایش کادرهای مرزی در اطراف اشیاء شناسایی شده استفاده کنید. اگر نتوانستید شیء درخواستی را پیدا کنید، به صورت کلامی به کاربر اطلاع دهید. همچنین، به هر سوال کلی که کاربر در مورد آنچه در فریم‌ها قابل مشاهده است، پاسخ دهید. پاسخ‌های گفتاری خود را مختصر و مفید نگه دارید.",
